...
### Media and Images ###
- Credit to [Tristan Sterling](https://www.sterlingandcophotography.com/etc/) also known as captainsterling on Instagram, it is his amazing photographs i was kind enough to borrow.

- Credit to [Alexotos](https://www.alexotos.com/), a huge profile in the keyboard community who let me use his images, the hero image is from him.

- Did some photo modifications on [Photopea](https://www.photopea.com/)

### Code troubleshooting credits ###

- Inspiration and code help from the [Love Running](https://github.com/Code-Institute-Solutions/love-running-2.0-sourcecode)

- Code inspiration to put the hero-image-logo.png on top of hero-image.jpg [Stackoverflow](https://stackoverflow.com/questions/12991351/css-force-image-resize-and-keep-aspect-ratio) (scratched that idea later on)

- Tips for the [static-navbar](https://www.w3docs.com/snippets/css/how-to-create-a-fixed-navbar-with-css.html)

- CSS [Gradient](https://cssgradient.io/) tool for the navbar, used to set my colors on my navbar.

- Found this on [stackoverflow](https://stackoverflow.com/questions/4126708/is-it-possible-to-style-html5-audio-tag) how you can style the audio tag

- Learned about [Z-index](https://www.freecodecamp.org/news/z-index-in-css-what-it-is-and-what-it-does/#:~:text=What%20is%20a%20Z%20Index,%2C%20or%20position%3Afixed%20) from

- My mentor Nikki helped me understand [flex-box](https://css-tricks.com/snippets/css/a-guide-to-flexbox/) by sending me this link and also the auto refresh function on formdump.html

- The code for auto refresh my mentor Nikki learned me meta http-equiv="refresh" content="10; url=index.html"
...
- This [site](https://caniuse.com/) taught me that i have to have p inside a li element

- Google [Fonts](https://fonts.google.com/) for the "Playfair Display" font used on the site.

- Solved two scrollbars by googling and found this thread on [stackoverflow](https://stackoverflow.com/questions/9866220/why-are-two-vertical-scrollbars-showing)

- This [page](https://stackoverflow.com/questions/12221692/http-error-405-0-method-not-allowed-post-fails) helped figure out the form problem, use GET instead of POST

- Learned more about responsive images from this [link](https://www.w3schools.com/howto/howto_css_image_responsive.asp)
